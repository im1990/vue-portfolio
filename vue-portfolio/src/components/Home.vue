...
export default {
    ...
    //     this.incomeRef = this.database.ref('income/' + this.uid);
    //     this.expeseRef = this.database.ref('expese/' + this.uid);
    //     this.shoppingRef = this.database.ref('shopping/' + this.uid);

    //     this.incomeRef.on('value', (snapshot) => {
    //         this.income = snapshot.val();
    //         // snapshot:ある時点における特定のデータベース参照にあるデータの全体像を写しとったもの
    //     });

    //     this.expenseRef.on('value', (snapshot) => {
    //         this.expense = snapshot.val();
    //     });

    //     this.shoppingRef.on('value', (snapshot) => {
    //         this.shopping = snapshot.val();
    //     });
    ...
    methods: {
        ...
        removeExpenseList: function(item) {
            ...
            // this.expenseRef.splice(index, 1)
        },
        ...
        addShoppingItem: function(item) {
            ...
            // firebase cloud store へデータを保存
            // this.shoppingRef.push(item.name)
        },
        ...
        removeShoppingList: function(item) {
            ...
            // this.shoppingRef.splice(index, 1)
        },
